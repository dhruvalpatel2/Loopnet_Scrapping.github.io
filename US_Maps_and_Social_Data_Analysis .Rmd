...
---
title: "US Maps and Social Data Analysis"
output: html_document
Name : Dhruval Patel
Class: Data Wrangling with R 
runtime: shiny
---
...
This report presents a comprehensive analysis of US social data through interactive maps and statistical plots. Our goal is to explore various demographic and economic indicators to provide insights into business and social environments across the states.

US Listings Map

The first section of our application provides a map visualizing real estate listings across the US, integrated with data on economic indicators influencing business environments.

```{r listings-map,echo = TRUE}
ui <- fluidPage(
...
This section provides a demographic breakdown of each state with associated economic data. We present insights into median income levels, crime rates, and how these may interrelate.

```{r state-demographics-map,echo = FALSE}
...
Analysis of Economic Factors and Crime Rate

In our analysis, we explore the relationship between economic factors like median household income and crime rates across different states.


Conclusion

The application developed through R Shiny and visualized in this report allows for an interactive exploration of socio-economic data across the US. By integrating various data sources and utilizing statistical analyses, we aim to provide a clear picture of the social and economic landscape of the US, helping stakeholders make informed decisions.
